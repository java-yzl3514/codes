...
-- CREATE DATABASE ap;
-- \connect ap;
CREATE SCHEMA ap AUTHORIZATION YOUR_DB_USER;
-- select the database
-- \connect ap;
...
(
  ...
  CONSTRAINT line_items_fk_invoices
    ...
    REFERENCES ap.invoices (invoice_id),
...
CREATE INDEX invoices_invoice_date_ix
  ON ap.invoices (invoice_date DESC);
...
INSERT INTO ap.general_ledger_accounts VALUES
(100,'Cash'),
...
INSERT INTO ap.vendor_contacts VALUES
(5,'Davison','Michelle'),
(12,'Mayteh','Kendall'),
(17,'Onandonga','Bruce'),
(44,'Antavius','Anthony'),
